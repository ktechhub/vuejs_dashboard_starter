<template>
  <div class="card overflow-hidden shadow-lg" :style="`background-image: url(${img});
      ...
      <div class="row">
        ...
        <div class="col-4">
          <div class="dropdown text-end mb-6">
            <a href="javascript:;" class="cursor-pointer" :class="{ show: showMenu }" id="dropdownUsers1"
          ...
          <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0" :class="class_percentage">{{
            percentage
          }}</p>
        </div>
      </div>
